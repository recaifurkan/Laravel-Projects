    ...
    <div style="z-index: 999; float: left" class="col-md-12">
       ...
       <hr>
        ...
        <div class="box box-primary">
          ...
          <h3 class="box-title">Haber Düzenle -> {{$haber->kategori->name}}</h3>
          </div><!-- /.box-header -->
          <div>  
        ...
        <input type="hidden" name="haberId" value="{{(isset($haber->id))?$haber->id:''}}">
          <div class="box-body">
            ...
            <input name="haberKeywords" value="{{$haber->keywords}}" type="text" class="form-control" >
            </div>
            <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input value="{{$haber->kisa_aciklama}}" name="haberAciklamasi" type="text" class="form-control"  placeholder="Haber Açıklaması">
                </div>
