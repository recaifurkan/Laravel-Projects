...
<html>
  <head>
    ...
    <title>Klinikçi Admin Panel</title> 
  ...
  <body class="skin-blue">
    <!-- Site wrapper -->
      ...
      <header class="main-header">
        ...
        <a href="/admin/anasayfa" class="logo"><b>Klinikçi </b> Admin</a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{route('profilResim',['uyeId'=>Auth::user()->id])}}" class="user-image" alt="{{isset(Auth::user()->name) ? Auth::user()->name: Auth::user()->kullanici_adi }}"/>
